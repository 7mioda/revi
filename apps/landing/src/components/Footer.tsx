...
export function Footer() {
  return (
    <footer className="w-full" style={{ backgroundColor: "#fafaf9" }}>
          ...
          <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
            ...
            <a href="/" className="flex items-center gap-2">
              <Image
                ...
                className="h-6 w-6"
              />
              <span className="text-[14px] font-semibold text-[#0a0908]">
                Lyse
              </span>
            </a>
                  ...
                  <ul className="flex flex-col gap-2">
                    {group.links.map((link) => (
                      <li key={link.label}>
                        <a
                          href={link.href}
                          className="text-[14px] transition-colors duration-150 hover:text-[#0a0908]"
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="transition-colors duration-150 hover:text-[#0a0908]"
